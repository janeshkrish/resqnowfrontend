...
const Chatbot = () => {
  ...
  return (
    <>
      ...
      {/* Chat window */}
      {open && (
        <div className="fixed bottom-6 right-6 z-50 w-80 sm:w-96 max-w-[90vw] bg-white rounded-xl shadow-2xl border border-gray-200 flex flex-col animate-fade-in-scale origin-bottom-right overflow-hidden">
          {/* Header */}
          ...
          >
            ...
            {loading && (
              <div className="flex justify-start animate-fade-in">
                <div className="bg-white border border-gray-100 text-gray-400 rounded-2xl rounded-bl-none px-4 py-3 text-sm shadow-sm flex items-center gap-1">
