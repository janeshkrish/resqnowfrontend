        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/terms-of-service" className="text-gray-300 hover:text-red-500 transition-colors">Terms of Service</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">KGiSL Campus, Coimbatore, Tamil Nadu, India</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-red-500 mr-3 flex-shrink-0" />
                <div className="flex flex-col">
                  <a href="tel:+919566510080" className="text-gray-300 hover:text-red-500 transition-colors">+91 9566510080</a>
                  <a href="tel:+919994806667" className="text-gray-300 hover:text-red-500 transition-colors">+91 9994806667</a>
                </div>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-red-500 mr-3 flex-shrink-0" />
                <a href="mailto:resqnow01@gmail.com" className="text-gray-300 hover:text-red-500 transition-colors">resqnow01@gmail.com</a>
              </li>
              <li className="flex items-center">
