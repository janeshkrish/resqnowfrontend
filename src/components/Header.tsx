              ...
              >
                ...
                {active && (
                  <motion.div
                    ...
                    className="absolute -bottom-1 left-0 right-0 h-[3px] rounded-full bg-[#E53935] overflow-hidden shadow-[0_2px_8px_rgba(229,57,53,0.4)]"
                    transition={{ type: "spring", stiffness: 300, damping: 30 }}
                  >
                    {/* High-speed tracking blip running across the line */}
                    <motion.div
                      className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r from-transparent via-white to-transparent opacity-80"
                      initial={{ x: "-100%" }}
                      animate={{ x: "200%" }}
                      transition={{ 
                        duration: 1.5, 
