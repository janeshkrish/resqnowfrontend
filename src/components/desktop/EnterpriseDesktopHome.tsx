...
const CitiesWeServeSection = () => {
  return (
    <section id="cities" className="pt-24 pb-0 bg-white relative overflow-hidden flex flex-col">
      <div className="container mx-auto max-w-7xl px-4 lg:px-8 relative z-10 text-center mb-12">
        <Reveal>
          ...
          <h2 className="text-4xl lg:text-[3.5rem] font-black tracking-tight text-slate-900 mb-6 leading-tight">
      ...
      <div className="relative w-full mt-auto h-[400px] lg:h-[500px] w-full">
        ...
        {/* Wavy bottom divider (optional, if we want to contain the map) */}
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] z-20 rotate-180">
          <svg
            className="relative block w-[calc(130%+1.3px)] h-[60px] lg:h-[100px]"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
            preserveAspectRatio="none"
          >
        ...
        <div className="absolute inset-0 bg-slate-100 z-10 overflow-hidden">
          ...
          >
            <div className="bg-white/90 backdrop-blur-md px-6 py-3 rounded-2xl shadow-2xl border border-white flex flex-col items-center mb-4">
              <span className="text-2xl font-black text-slate-900 tracking-tight">Coimbatore</span>
              <span className="text-[10px] font-bold text-blue-600 uppercase tracking-widest mt-1">HQ / Phase 1 Grid</span>
            </div>
            <div className="w-6 h-6 rounded-full bg-blue-600 shadow-[0_0_30px_rgba(37,99,235,0.8)] border-[4px] border-white z-10 relative">
