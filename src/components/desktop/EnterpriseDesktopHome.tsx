...
const PremiumDashboardMockup = () => {
  return (
    <div className="relative w-full max-w-[800px] mx-auto perspective-1000">
      <div className="absolute inset-0 -m-20 bg-gradient-to-tr from-red-500/20 via-transparent to-emerald-500/20 rounded-full blur-3xl opacity-50" />
      ...
      >
        ...
        <div className="flex items-center justify-between pb-6 mb-6 border-b border-slate-200/50">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-slate-900 to-red-950 shadow-inner">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.8fr_1fr]">
          ...
          <div className="relative h-[380px] rounded-xl bg-slate-50 border border-slate-200/60 overflow-hidden shadow-inner">
            ...
            >
              ...
              <div className="w-12 h-12 bg-white rounded-xl shadow-lg border border-slate-200 flex items-center justify-center z-10 relative overflow-hidden group">
                <div className="absolute inset-0 bg-red-50 translate-y-full group-hover:translate-y-0 transition-transform" />
                <Truck size={20} className="text-red-600 relative z-10" />
              </div>
              
              {/* Floating Tooltip */}
              <motion.div 
                className="absolute bottom-full mb-4 bg-gradient-to-r from-slate-900 to-red-950 text-white p-3 rounded-xl shadow-2xl min-w-[140px] z-20"
              ...
              >
                ...
                <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-4 h-4 bg-gradient-to-r from-slate-900 to-red-950 rotate-45" />
              </motion.div>
            </motion.div>
          ...
          <div className="flex flex-col gap-4">
            <motion.div 
              className="bg-gradient-to-r from-slate-900 to-red-950 rounded-xl p-5 shadow-lg relative overflow-hidden group"
              whileHover={{ y: -2 }}
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/20 rounded-full blur-2xl -translate-y-10 translate-x-10 group-hover:bg-red-500/30 transition-colors" />
        ...
        <Reveal>
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold leading-[1.05] tracking-tighter text-slate-900 mb-6">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-indigo-600 to-red-600 bg-300% animate-gradient">
                Modern Mobility.
              </span>
            </h1>
          ...
          {problems.map((problem, i) => (
            <motion.div key={i} variants={fadeUp} className="group cursor-pointer">
              <div className="h-full bg-slate-50/50 border border-slate-100 p-8 rounded-[2rem] transition-all duration-300 hover:bg-white hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="w-14 h-14 bg-white rounded-2xl shadow-sm border border-slate-200 flex items-center justify-center mb-8 text-red-600 group-hover:bg-red-600 group-hover:text-white transition-colors duration-300">
...
const WorkflowSection = () => {
  ...
  return (
    <section id="technology" className="py-24 lg:py-32 bg-[#fafafa] border-y border-slate-200/60 relative overflow-hidden">
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-red-500/5 blur-[120px] rounded-full pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-4 gap-12 lg:gap-8 relative z-10">
            {steps.map((step, i) => (
              ...
              >
                ...
                >
                  <step.icon size={32} className="text-slate-700 transition-colors group-hover:text-red-600" />
                  <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-gradient-to-r from-slate-900 to-red-950 text-white font-bold text-sm flex items-center justify-center shadow-lg border-2 border-white">
                    {i + 1}
                  </div>
                </motion.div>
      ...
      >
        <div className="bg-slate-50 border border-slate-200/60 rounded-[3rem] p-12 lg:p-24 text-center relative overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)]">
          ...
          <div className="relative z-10 flex flex-col items-center">
            <motion.div 
              className="w-20 h-20 bg-white shadow-sm text-red-600 rounded-2xl flex items-center justify-center mb-8 border border-slate-100"
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full sm:w-auto">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                <Button size="xl" className="w-full h-16 px-10 rounded-2xl bg-gradient-to-r from-slate-900 to-red-950 text-white text-lg font-bold hover:from-slate-800 hover:to-red-900 shadow-xl border border-slate-800" asChild>
