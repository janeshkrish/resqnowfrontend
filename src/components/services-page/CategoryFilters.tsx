        ...
        return (
          <button
            ...
            className={cn(
              ...
              isSelected
                ? "text-red-700 shadow-[0_10px_30px_-10px_rgba(37,99,235,0.3)] bg-white border border-red-100"
          ...
          >
            {isSelected && (
              <motion.div 
                ...
                className="absolute inset-0 bg-red-50/50 rounded-2xl border border-red-200/50 -z-10"
                transition={{ type: "spring", stiffness: 300, damping: 30 }}
              />
            )}
            <div className={cn(
              "w-10 h-10 rounded-xl flex items-center justify-center transition-colors duration-300",
              isSelected ? "bg-red-100 text-red-600" : "bg-white text-slate-400 shadow-sm"
            )}>
