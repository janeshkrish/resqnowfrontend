...
const AuthSuccess = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-muted">
            ...
            <h2 className="text-xl font-semibold text-muted-foreground">Logging you in...</h2>
            <p className="text-muted-foreground/80 text-sm mt-2">Please wait while we verify your credentials.</p>
        </div>
    );
};
